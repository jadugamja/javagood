package a.b.c.com.yjs.mem.controller;
				...
				if (bool){
					...
					if (bFile){
						...
						if (bInsert){						
							...
							RequestDispatcher rd = request.getRequestDispatcher("/yjs/mem/memInsert.jsp");
							rd.forward(request, response);						
						}else{
							out.println("<script>");				
							out.println("location.href='/testYjs/yjs/mem/mem.html'");
							out.println("</script>");
						}
