...
public class FileUploadServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) 
		...
		String saveDirectory = "C:\\00.KOSMO93\\30.Web\\el_web_neon_work\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\testYjs\\fileupload";
		...
		try {
			...
			if (aList !=null && aList.size() > 0){
				...
				out.println("<script>");				
				out.println("location.href='/testYjs/cgiTest/fileUpload.html'");
				out.println("</script>");
			}
