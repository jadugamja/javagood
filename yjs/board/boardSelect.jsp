...
<%@page import="a.b.c.com.yjs.board.service.BoardService"%>
<%@page import="a.b.c.com.yjs.board.service.BoardServiceImpl"%>    
<%@page import="a.b.c.com.yjs.board.vo.BoardVO"%>    
...
<script type="text/javascript">
	...
	function boardUpdate(actionUpdate){
		...
		if ('U' == actionUpdate){
			var v1 = "UOK";		
			document.boardUpdateForm.action="/testYjs/board?ISUD_TYPE="+v1;			
		}
		
		if ('D' == actionUpdate){
			var v2 = "DOK";
			document.boardUpdateForm.action="/testYjs/board?ISUD_TYPE="+v2;
		}
	...
	function checkAction(actionName){
		...
		if ('I' == actionName){	
			location.href="/testYjs/yjs/board/board.html";
		}
		if ('SALL' == actionName){			
...
<tr>	
	<td colspan="2" align="center">	
		...
		<img src="/testWeb/img/img_mando/ase.gif" width="25" height="25" alt="image">		
	</td>				
</tr>
<tr>
	<td class="tt">글번호</td>
...
<tr>
	<td  class="tt">내용</td>
	<td>
	<textarea name="bcontents" id="bcontents" cols="50" rows="10"><%= bcontents %></textarea>
</td>
</tr>
<tr>
	<td  class="tt">사진</td>
