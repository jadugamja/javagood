...
<html>
		...
		$(document).ready(function(){	
			...
			function send(isudType){
				...
				$("#boardSelectAllForm").attr({
					"action":"/testYjs/board?ISUD_TYPE="+isudType,
					"method":"GET",
	...
	<font size="4" color="blue">
		<img src="/testWeb/img/img_mando/ase.gif" width="25" height="25" alter="image">
		BOARD TEST
	</font>
	</td>
	</tr>
	...
	<hr>
		...
		%>					
			...
			<tr>
				...
				<td class="tt"><%= bvo.getBcontents() %> </td>
				<td class="tt"><%= bvo.getBpw() %> </td>	
				<td class="tt"><img src="/testYjs/fileupload/board/<%= bvo.getBphoto() %> " border="1" width="25" height="25" alt="image"></td>
