...
<%@page import="a.b.c.com.yjs.book.service.BookService"%>
<%@page import="a.b.c.com.yjs.book.service.BookServiceImpl"%>    
<%@page import="a.b.c.com.yjs.book.vo.BookVO"%>    
...
<script type="text/javascript">
	...
	function bookUpdate(actionUpdate){
		...
		if ('U' == actionUpdate){
			document.bookUpdateForm.action="/testYjs/book?isudtype=UOK";			
		}
		
		if ('D' == actionUpdate){
			document.bookUpdateForm.action="/testYjs/book?isudtype=DOK";
		}
	...
	function checkAction(actionName){
		...
		if ('I' == actionName){	
			location.href="/testYjs/yjs/book/book.html";
		}
		if ('SALL' == actionName){			
			location.href="/testYjs/book?isudtype=SALL";
		}
	}	
</script>
</head>
