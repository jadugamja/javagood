...
<%@page import="a.b.c.com.yjs.mem.service.MemberService"%>
<%@page import="a.b.c.com.yjs.mem.service.MemberServiceImpl"%>    
<%@page import="a.b.c.com.yjs.mem.vo.MemberVO"%>  
...
<script type="text/javascript">
	...
	function memUpdate(actionUpdate){
		...
		if ('U' == actionUpdate){
			var v1 = "UOK";		
			document.memUpdateForm.action="/testYjs/mem?ISUD_TYPE="+v1;			
		}
		
		if ('D' == actionUpdate){
			var v2 = "DOK";
			document.boardUpdateForm.action="/testYjs/mem?ISUD_TYPE="+v2;
		}
	...
	function checkAction(actionName){
		...
		if ('I' == actionName){	
			location.href="/testYjs/yjs/mem/mem.html";
		}
		if ('SALL' == actionName){			
			location.href="/testYjs/mem?ISUD_TYPE=SALL";
		}
	}	
</script>
</head>
...
<div>
	<form name="memUpdateForm" id="memUpdateForm">
		...
		<tr>
			...
			<td rowspan="5">
				<img class="photo" src="/testYjs/fileupload/member/<%= mvo.getMphoto() %>" alt="image">
			</td>	
		</tr>
		<tr>
			<td>이름</td>
