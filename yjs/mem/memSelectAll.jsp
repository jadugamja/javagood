...
<script type="text/javascript">
	...
	$(document).ready(function(){	
		...
		// 전체조회
		$("#SALL").click(function(){
			// ? 이건.. MemberController.java에 선언된 것과 같은..
		...
		function send(isudType){
			...
			$("#memSelectAllForm").attr({
				"action":"/testYjs/mem?ISUD_TYPE="+isudType,
				"method":"GET",
	...
	<table>
		<tr>
			<td calspan="2">
				...
				<img src="/testWeb/img/ase.gif" width="25" height="25" alter="image">
				BOARD TEST
				</font>
			</td>
		</tr>
...
<hr>
	<form name="memSelectAllForm" id="memSelectAllForm">
		...
		<tr>
			...
			<td class="tt"><img src="/testYjs/fileupload/member/<%= mvo.getMphoto() %> " border="1" width="25" height="25" alt="image"></td>	
